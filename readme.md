...
- A large debuff icon on a raid frame.  
- The other tanks get a big red "Taunt!" text message.  
...
- Adds circle soak, Dark Spin, Inferno and vulnerability swap timers to DBM in heroic mode. Credits to Mec for sharing his DBM file which was used here.  

**HP bars:**  

- Shows HP of the both bosses.

**Circle soak:**  

- Raid lead can set up assignments for 10 soak zones combined, fire and shadow, plus backups. Sunwell Pack -> Backend -> Twins Soak Assignments -> Custom Options.  
- Need to assign at least 4 people for each zone.  
- Duplicates and unit names that do not exist are removed.  
- Any player in a raid can type "assignments" or "soakers" to make the raid leader send the assignments.  
- Current soak wave assignments update after people get different vulnerability debuff, a soak debuff or if someone dies.  
- Assignments widget shows current wave assignments for all zones. Own name is highlighted with green color.  
- Players get notified with a big icon when it is their turn to soak. The text above the icon is what zone the player needs to cover. The timer is for when to soak.  
- Ten seconds before a player has to soak they will get notified with a big red text message on a screen including the zone.  
- Five seconds before a player has to soak they will get notified with the "bike horn" squeaky sound three times.  

**Conflagrate**  

- DOT debuff on a debuffed player's raid frame.  
- Glow on a debuffed player's raid frame.  
- A debuffed player gets notified with a big Conflagrate icon with a "DOT" text above.  
- A target during the cast gets notified with "Run Away" sound, big fireball icon and big "Run out" text.  

**Shadow Nova**  

- A target during the cast gets notified with "Run Away" sound, big icon and big "Run out" text.  

**Confounding Blow**  

- A target gets notified with a big icon.  
- A large debuff icon is shown on a player's raid frame.  

**Flame Sear**  

- A target gets notified with a big icon and a notification type sound.  
- A large debuff icon is shown on a player's raid frame.  
- A debuffed player's raid frame glows red.  

**Pyrogenics**  

- Players without shadow vulnerability and with a dispel ability get notified with a big icon and a notification type sound.  

**Shadow Mend (clones heal)**  

- Raid leader sends a raid warning chat message when a clone heals one of the bosses.  

**Blaze**  

- If a player walks into a flame patch they get notified with a repeaded "error" sound and a small "Blaze!" message.  

**Misc:**  
- Smal debuff icons are shown for vulnerability debuffs, soak debuffs, Dark Strike, Flame Touched and Dark Touched.  